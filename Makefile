...
ifeq ($(MINIZ_ENABLED),1)
    CFLAGS += -DUSE_MINIZ -Ithird_party/miniz -DMINIZ_NO_ARCHIVE_APIS
...
$(BIN_DIR)/universal_comp.exe: $(OBJ_DIR)/universal_cli.o $(OBJ_DIR)/comp_container.o $(OBJ_DIR)/zlib_adapter.o $(OBJ_DIR)/crc32.o $(OBJ_DIR)/deflate_wrapper.o $(OBJ_DIR)/logger.o $(OBJ_DIR)/logger_shim.o $(OBJ_DIR)/image_compressor_stub.o $(MINIZ_OBJ) $(LZMA_OBJ)
...
$(OBJ_DIR)/image_compressor_stub.o: $(SRC_DIR)/image_compressor_stub.c $(INCLUDE_DIR)/compressor.h
	$(CC) $(CFLAGS) -I$(INCLUDE_DIR) -c $(SRC_DIR)/image_compressor_stub.c -o $(OBJ_DIR)/image_compressor_stub.o
...
$(OBJ_DIR)/universal_cli.o: $(SRC_DIR)/universal_cli.c $(INCLUDE_DIR)/comp_container.h $(INCLUDE_DIR)/zlib_adapter.h
	$(CC) $(CFLAGS) -I$(INCLUDE_DIR) -c $(SRC_DIR)/universal_cli.c -o $(OBJ_DIR)/universal_cli.o

# Vendored miniz object
$(OBJ_DIR)/miniz.o: third_party/miniz/miniz.c third_party/miniz/miniz.h
	$(CC) $(CFLAGS) -I$(INCLUDE_DIR) -Ithird_party/miniz -c third_party/miniz/miniz.c -o $(OBJ_DIR)/miniz.o

$(OBJ_DIR)/miniz_tdef.o: third_party/miniz/miniz_tdef.c third_party/miniz/miniz_tdef.h third_party/miniz/miniz_common.h
	$(CC) $(CFLAGS) -I$(INCLUDE_DIR) -Ithird_party/miniz -c third_party/miniz/miniz_tdef.c -o $(OBJ_DIR)/miniz_tdef.o

$(OBJ_DIR)/miniz_tinfl.o: third_party/miniz/miniz_tinfl.c third_party/miniz/miniz_tinfl.h third_party/miniz/miniz_common.h
	$(CC) $(CFLAGS) -I$(INCLUDE_DIR) -Ithird_party/miniz -c third_party/miniz/miniz_tinfl.c -o $(OBJ_DIR)/miniz_tinfl.o

$(OBJ_DIR)/deflate_wrapper.o: $(SRC_DIR)/deflate_wrapper.c
	$(CC) $(CFLAGS) -I$(INCLUDE_DIR) -Ithird_party/miniz -c $(SRC_DIR)/deflate_wrapper.c -o $(OBJ_DIR)/deflate_wrapper.o
...
$(OBJ_DIR)/lzma_sdk_stub.o: $(SRC_DIR)/lzma_sdk_stub.c third_party/miniz/miniz.h
	$(CC) $(CFLAGS) -I$(INCLUDE_DIR) -Ithird_party/miniz -c $(SRC_DIR)/lzma_sdk_stub.c -o $(OBJ_DIR)/lzma_sdk_stub.o
